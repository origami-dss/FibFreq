...
print(freq_est(ecg1, delta_t = delta_t))
print(freq_mode_periodogram(ecg1, delta_t = delta_t))
freq_max2max(ecg1, delta_t = delta_t)
freq_threshold_crossing(ecg1, delta_t = delta_t)
